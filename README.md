...
[![My Skills](https://skillicons.dev/icons?i=js,nodejs,ts,react,vite,angular,docker,html,css,htmx,tailwind,c,cpp,dart,flutter,java,kotlin,discord,eclipse,express,figma,firebase,git,bash,bitbucket,gradle,jest,linux,mongodb,mysql,sqlite,yarn,notion,npm,php,postman,replit,stackoverflow,vscode,idea,notion,apple,windows)](https://skillicons.dev)
